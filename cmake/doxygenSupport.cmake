...
IF( DOXYGEN_FOUND )
  IF( DOXYFILE_FOUND )
    ...
    IF(NOT DEFAULT_DOXYGEN_OUTPUT_DIR)
      SET(DEFAULT_DOXYGEN_OUTPUT_DIR "${CMAKE_CURRENT_BINARY_DIR}/_doxygen")
    ...
    CONFIGURE_FILE(
      ...
      "${CMAKE_CURRENT_BINARY_DIR}/${CMAKE_PROJECT_NAME}.doxygen"
      IMMEDIATE @ONLY)

    # Add target
    ADD_CUSTOM_TARGET(doxygen ${DOXYGEN_EXECUTABLE} "${CMAKE_CURRENT_BINARY_DIR}/${CMAKE_PROJECT_NAME}.doxygen")
